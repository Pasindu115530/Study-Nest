...
<head>
    ...
    <meta name="description" content="StudyNest - Faculty Dashboard">
    <!-- Boxicons CSS -->
        ...
        <div class="container">
            ...
            <section class="card-section" aria-label="Lecturer profiles">
                ...
                <div class="card">
                    ...
                    <p>Tel: +94 11 275 8909</p>
                    <div class="social-icons">
                        <a href="#" aria-label="LinkedIn profile"><i class='bx bxl-linkedin-square'></i></a>
                        <a href="#" aria-label="Website"><i class='bx bxl-wordpress'></i></a>
                    </div>
                </div>
                ...
                <!-- Card 8 -->
                <div class="card">
                    <img src="Assets/img/profile-gradient-logo-design-template-icon-vector.jpg" loading="lazy" alt="Mr. L D P S Jayasekara">
                    <h3>Mr. L D P S Jayasekara</h3>
                    <h6>Lecturer</h6>
                    <p>Email: pubudu@sjp.ac.lk</p>
                    <p>Tel: +94 711612267</p>
                    <div class="social-icons">
                        <a href="#" aria-label="LinkedIn profile"><i class='bx bxl-linkedin-square'></i></a>
                        <a href="#" aria-label="Website"><i class='bx bxl-wordpress'></i></a>
                    </div>
